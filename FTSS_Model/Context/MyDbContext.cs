   ...
   protected override void OnModelCreating(ModelBuilder modelBuilder)
{
    modelBuilder.Entity<Booking>(entity =>
    {
        ...
        entity.HasIndex(e => e.BookingCode, "idx_booking_bookingcode").IsUnique();
    });
    ...
    modelBuilder.Entity<Image>(entity =>
    {
        ...
        // Chỉ mục cho Image
        entity.HasIndex(e => e.ProductId, "idx_image_productid");
    ...
    modelBuilder.Entity<Issue>(entity =>
    {
        ...
        // Chỉ mục cho Issue
        entity.HasIndex(e => e.IssueCategoryId, "idx_issue_issuecategoryid");
    ...
    modelBuilder.Entity<Order>(entity =>
    {
        ...
        // Chỉ mục cho Order (đã có, giữ nguyên)
        ...
        entity.HasIndex(e => e.VoucherId, "idx_order_voucherid");
        entity.HasIndex(e => e.SetupPackageId, "idx_order_setuppackageid");
        entity.HasIndex(e => e.OrderCode, "idx_order_ordercode").IsUnique();
    ...
    modelBuilder.Entity<OrderDetail>(entity =>
    {
        ...
        // Chỉ mục cho OrderDetail
        entity.HasIndex(e => e.OrderId, "idx_orderdetail_orderid");
        entity.HasIndex(e => e.ProductId, "idx_orderdetail_productid");
    });
    ...
    modelBuilder.Entity<Payment>(entity =>
    {
        ...
        // Chỉ mục cho Payment
        entity.HasIndex(e => e.OrderId, "idx_payment_orderid");
    ...
    modelBuilder.Entity<Product>(entity =>
    {
        ...
        // Chỉ mục cho Product
        entity.HasIndex(e => e.SubCategoryId, "idx_product_subcategoryid");
    ...
    modelBuilder.Entity<SetupPackageDetail>(entity =>
    {
        ...
        // Chỉ mục cho SetupPackageDetail
        entity.HasIndex(e => e.SetupPackageId, "idx_setuppackagedetail_setuppackageid");
        entity.HasIndex(e => e.ProductId, "idx_setuppackagedetail_productid");
    });
    ...
    modelBuilder.Entity<Solution>(entity =>
    {
        ...
        // Chỉ mục cho Solution
        entity.HasIndex(e => e.IssueId, "idx_solution_issueid");
    ...
    modelBuilder.Entity<SubCategory>(entity =>
    {
        ...
        // Chỉ mục cho SubCategory
        entity.HasIndex(e => e.CategoryId, "idx_subcategory_categoryid");
